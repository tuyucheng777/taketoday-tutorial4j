...
import cn.tuyucheng.taketoday.dependencyinjection.imageprocessors.ImageFileProcessor;
...
public class ImageProcessorUnitTest {
   ...
   private LocalTime getLoggedTime(String log) throws ParseException {
      ...
      int hour = Integer.parseInt(logTimeString.split(":")[0]);
      int minutes = Integer.parseInt(logTimeString.split(":")[1]);
