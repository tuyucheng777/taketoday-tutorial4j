package cn.tuyucheng.taketoday.passay;
...
public class NegativeMatchingRulesUnitTest {
   ...
   public void givenPasswordAndHashBeanAndEncryptedReferences_whenValidate_thenPasswordValidationShouldPass() {
      List<PasswordData.Reference> historicalReferences = List.of(new PasswordData.HistoricalReference("SHA256", "2e4551de804e27aacf20f9df5be3e8cd384ed64488b21ab079fb58e8c90068ab"));
