package cn.tuyucheng.taketoday.libraries.docx;
...
class Docx4jExample {
   ...
   void createDocumentPackage(String outputPath, String imagePath) throws Exception {
      ...
      mainDocumentPart.addParagraphOfText("Welcome To Taketoday!");

      ObjectFactory factory = Context.getWmlObjectFactory();
      P p = factory.createP();
      R r = factory.createR();
      Text t = factory.createText();
      t.setValue("Welcome To Taketoday");
      r.getContent().add(t);
      p.getContent().add(r);
      ...
      Inline inline = imagePart.createImageInline("Taketoday Image", "Alt Text", 1, 2, false);
