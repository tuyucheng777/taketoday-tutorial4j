package cn.tuyucheng.taketoday.libraries.snakeyaml;
...
public class JavaToYAMLSerializationUnitTest {
   ...
   public void whenDumpACustomType_thenGenerateCorrectYAML() {
      ...
      String expectedYaml = "!!cn.tuyucheng.taketoday.libraries.snakeyaml.Customer {age: 45, contactDetails: null, firstName: Greg,\n  homeAddress: null, lastName: McDowell}\n";
      assertEquals(expectedYaml, writer.toString());
   }
