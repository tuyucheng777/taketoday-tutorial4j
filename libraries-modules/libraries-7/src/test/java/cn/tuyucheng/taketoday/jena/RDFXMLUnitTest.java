...
public class RDFXMLUnitTest {
   ...
   void whenWeHaveAModel_ThenWeCanSerializeAsRDFXMLUsingRDFDataMgr() {
      ...
      model.createResource("tag:tuyucheng:/blog/posts/123")
            .addProperty(SchemaDO.headline, "Introduction to RDF and Apache Jena")
            .addProperty(SchemaDO.wordCount, "835")
            .addProperty(SchemaDO.author, model.createResource("tag:tuyucheng:/users/Tuyucheng")
                  .addProperty(SchemaDO.name, "Tuyucheng")
                  .addProperty(SchemaDO.url, "https://tuyucheng.com"))
            .addProperty(SchemaDO.comment, model.createResource("tag:tuyucheng:/blog/posts/123/comments/1")
                  .addProperty(SchemaDO.text, "What a great article!")
                  .addProperty(SchemaDO.author, model.createResource("tag:tuyucheng:/users/JoeBloggs")
      ...
      assertEquals("""
            <rdf:RDF
              ...
              <rdf:Description rdf:about="tag:tuyucheng:/blog/posts/123">
                <j.0:comment>
                  <rdf:Description rdf:about="tag:tuyucheng:/blog/posts/123/comments/1">
                    <j.0:author>
                      <rdf:Description rdf:about="tag:tuyucheng:/users/JoeBloggs">
                ...
                <j.0:author>
                  <rdf:Description rdf:about="tag:tuyucheng:/users/Tuyucheng">
                    <j.0:url>https://tuyucheng.com</j.0:url>
                    <j.0:name>Tuyucheng</j.0:name>
                  </rdf:Description>
                </j.0:author>
   ...
   void whenWeHaveRDFXML_thenWeCanParseThis() {
      ...
      Resource blogPost = model.getResource("tag:tuyucheng:/blog/posts/123");
