...
import cn.tuyucheng.taketoday.libraries.ebean.model.Address;
import cn.tuyucheng.taketoday.libraries.ebean.model.Customer;
import io.ebean.DB;
...
public class App {
   ...
   private static Customer getCustomer() {
      Address a1 = new Address("1, Big Street", null, "New York");
      return new Customer("Big John", a1);
   }
}