...
public class FunctionalJavaIOMain {
   ...
   public static void main(String[] args) {
      F<String, IO<Unit>> printLetters = FunctionalJavaIOMain::printLetters;
      ...
      F<String, String> toUpperCase = String::toUpperCase;
      ...
      IO<Unit> program = IOFunctions.bind(userInput, _ -> readAndPrintResult);
