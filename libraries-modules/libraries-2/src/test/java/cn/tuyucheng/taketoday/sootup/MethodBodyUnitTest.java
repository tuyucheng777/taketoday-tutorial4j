...
public class MethodBodyUnitTest {
   ...
   void whenAnalyzingAMethod_thenWeCanAccessTheLocals() {
      Path javaFile = Path.of("src/test/java/cn/tuyucheng/taketoday/sootup/MethodBodyUnitTest.java");
      AnalysisInputLocation inputLocation = new OTFCompileAnalysisInputLocation(javaFile);

      JavaView view = new JavaView(inputLocation);

      IdentifierFactory identifierFactory = view.getIdentifierFactory();
      ClassType javaClass = identifierFactory.getClassType("cn.tuyucheng.taketoday.sootup.MethodBodyUnitTest");
   ...
   void whenAnalyzingAMethod_thenWeCanAccessTheCallGraph() {
      ...
      assertThat(stmts.get(0)).asString().isEqualTo("this := @this: cn.tuyucheng.taketoday.sootup.MethodBodyUnitTest");
