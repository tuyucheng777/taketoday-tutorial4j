...
public class ContainerLiveTest {
   ...
   public void whenCreatingContainer_thenMustReturnContainerId() {
      // when
      CreateContainerResponse container = dockerClient.createContainerCmd("mongo:3.6").withCmd("--bind_ip_all").withName("mongo").withHostName("taketoday").withEnv("MONGO_LATEST_VERSION=3.6").withPortBindings(PortBinding.parse("9999:27017")).exec();
