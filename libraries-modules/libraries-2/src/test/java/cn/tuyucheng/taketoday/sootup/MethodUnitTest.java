...
public class MethodUnitTest {
   ...
   void whenAnalyzingThisClass_thenWeCanAccessMethods() {
      Path javaFile = Path.of("src/test/java/cn/tuyucheng/taketoday/sootup/MethodUnitTest.java");
      AnalysisInputLocation inputLocation = new OTFCompileAnalysisInputLocation(javaFile);

      JavaView view = new JavaView(inputLocation);

      IdentifierFactory identifierFactory = view.getIdentifierFactory();
      ClassType javaClass = identifierFactory.getClassType("cn.tuyucheng.taketoday.sootup.MethodUnitTest");
