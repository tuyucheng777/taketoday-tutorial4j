...
public class AnalyzeUnitTest {
   ...
   void getPackageName() {
      ...
      assertEquals("cn.tuyucheng.taketoday.javaparser", packageDeclaration.getName().asString());
   }
   ...
   void visitListMethodNames() {
      ...
      List<String> allMethods = compilationUnit.accept(new GenericListVisitorAdapter<>() {
         @Override
