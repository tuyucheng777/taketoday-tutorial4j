package cn.tuyucheng.taketoday.jool;
...
public class JOOLUnitTest {
   ...
   public void givenStreams_whenJoin_shouldHaveElementsFromTwoStreams() {
      ...
      // when
      List<Integer> rightCollected = right.toList();
   ...
   public void givenSeq_whenGroupByAndFold_shouldReturnProperSeq() {
      ...
      assertEquals("!abc", Seq.of("a", "b", "c").foldLeft("!", (u, t) -> u + t));

      assertEquals("abc!", Seq.of("a", "b", "c").foldRight("!", (t, u) -> t + u));
   }
   ...
   public void givenFunction_whenAppliedPartially_shouldAddNumberToPartialArgument() {
      // given
      Function2<Integer, Integer, Integer> addTwoNumbers = Integer::sum;
