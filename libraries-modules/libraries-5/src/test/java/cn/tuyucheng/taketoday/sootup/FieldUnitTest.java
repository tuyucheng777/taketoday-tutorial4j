...
public class FieldUnitTest {
   ...
   void whenAnalyzingThisClass_thenWeCanAccessFields() {
      Path javaFile = Path.of("src/test/java/cn/tuyucheng/taketoday/sootup/FieldUnitTest.java");
      AnalysisInputLocation inputLocation = new OTFCompileAnalysisInputLocation(javaFile);

      JavaView view = new JavaView(inputLocation);

      IdentifierFactory identifierFactory = view.getIdentifierFactory();
      ClassType javaClass = identifierFactory.getClassType("cn.tuyucheng.taketoday.sootup.FieldUnitTest");
