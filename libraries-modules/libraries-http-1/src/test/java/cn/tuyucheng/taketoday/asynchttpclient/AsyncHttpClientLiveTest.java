package cn.tuyucheng.taketoday.asynchttpclient;
...
public class AsyncHttpClientLiveTest {
   ...
   public void givenHttpClient_executeSyncGetRequest() {
      BoundRequestBuilder boundGetRequest = HTTP_CLIENT.prepareGet("http://www.taketoday.com");
   ...
   public void givenHttpClient_executeAsyncGetRequest() {
      ...
      Request unboundGetRequest = Dsl.get("http://www.taketoday.com").build();
