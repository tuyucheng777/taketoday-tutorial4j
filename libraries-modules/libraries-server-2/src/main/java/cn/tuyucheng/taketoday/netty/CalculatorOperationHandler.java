...
public class CalculatorOperationHandler extends SimpleChannelInboundHandler<Operation> {
   ...
   private long calculateEndpoint(Operation operation) {
      ...
      return switch (operator) {
         case "add" -> operation.getNumber1() + operation.getNumber2();
         case "multiply" -> (long) operation.getNumber1() * operation.getNumber2();
         default -> throw new IllegalArgumentException("Operation not defined");
      };
   }
