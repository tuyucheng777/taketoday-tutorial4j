package cn.tuyucheng.taketoday.jcommander.usagebilling;

import cn.tuyucheng.taketoday.jcommander.usagebilling.cli.UsageBasedBilling;
...
public class UsageBasedBillingApp {
    ...
    *  mvn exec:java \
         -Dexec.mainClass=cn.tuyucheng.taketoday.jcommander.usagebilling.UsageBasedBillingApp -q \
