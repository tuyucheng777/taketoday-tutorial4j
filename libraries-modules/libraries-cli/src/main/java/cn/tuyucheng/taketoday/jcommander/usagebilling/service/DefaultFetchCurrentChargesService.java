...
import cn.tuyucheng.taketoday.jcommander.usagebilling.model.CurrentChargesResponse.LineItem;
...
class DefaultFetchCurrentChargesService implements FetchCurrentChargesService {
   ...
   public CurrentChargesResponse fetch(CurrentChargesRequest request) {
      ...
      if (subscriptions == null || subscriptions.isEmpty()) {
         ...
         System.out.printf("Fetching charges for customer: %s and subscriptions: %s%n", request.getCustomerId(), subscriptions);
      }
