package cn.tuyucheng.taketoday.noexception;
...
public class NoExceptionUnitTest {
   ...
   public void givenCustomHandler_whenError_thenRethrowError() {
      ...
      customExceptionHandler.run(NoExceptionUnitTest::throwError);
   }

   @Test
   public void givenCustomHandler_whenException_thenCatchAndLog() {
      CustomExceptionHandler customExceptionHandler = new CustomExceptionHandler();
      customExceptionHandler.run(NoExceptionUnitTest::throwException);
   }
