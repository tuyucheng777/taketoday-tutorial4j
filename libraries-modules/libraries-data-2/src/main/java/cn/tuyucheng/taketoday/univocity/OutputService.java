package cn.tuyucheng.taketoday.univocity;
...
import cn.tuyucheng.taketoday.univocity.model.Product;
...
public class OutputService {
   ...
   public boolean writeData(List<Object[]> products, OutputType outputType, String outputPath) {
      try (Writer outputWriter = new OutputStreamWriter(new FileOutputStream(new File(outputPath)), StandardCharsets.UTF_8)) {
         switch (outputType) {
            case CSV: {
