package cn.tuyucheng.taketoday.suanshu;
...
class SuanShuMath {
   ...
   public void addingVectors() throws Exception {
      Vector v1 = new DenseVector(1, 2, 3, 4, 5);
      Vector v2 = new DenseVector(5, 4, 3, 2, 1);
      Vector v3 = v1.add(v2);
   ...
   public void solvePolynomial() {
      Polynomial p = new Polynomial(2, 2, -4);
