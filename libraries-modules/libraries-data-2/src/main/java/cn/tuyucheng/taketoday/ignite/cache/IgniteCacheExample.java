package cn.tuyucheng.taketoday.ignite.cache;
...
public class IgniteCacheExample {
   ...
   public static void main(String[] args) {
      ...
      IgniteCache<Integer, String> cache = ignite.cache("taketodayCache");

      cache.put(1, "taketoday cache value");

      String message = cache.get(1);
   }

   private static void getObjectFromCache(Ignite ignite) {
      IgniteCache<Integer, Employee> cache = ignite.getOrCreateCache("taketodayCache");
   ...
   private static void getFromCacheWithSQl(Ignite ignite) {
      IgniteCache<Integer, Employee> cache = ignite.cache("taketodayCache");
