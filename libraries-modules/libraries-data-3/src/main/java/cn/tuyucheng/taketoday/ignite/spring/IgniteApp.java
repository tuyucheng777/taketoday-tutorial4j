package cn.tuyucheng.taketoday.ignite.spring;

import cn.tuyucheng.taketoday.ignite.spring.config.SpringDataConfig;
...
public class IgniteApp {
   ...
   private void getUsingTheCache(Integer employeeId) {
      ...
      IgniteCache<Integer, EmployeeDTO> cache = ignite.cache("taketodayCache");
