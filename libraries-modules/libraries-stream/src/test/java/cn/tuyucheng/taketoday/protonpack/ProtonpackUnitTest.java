...
public class ProtonpackUnitTest {
   ...
   public void whenAggregated_thenAggregated() {
      ...
      List<List<Integer>> aggregated = StreamUtils
            ...
            .collect(Collectors.toList());
      assertThat(aggregated).containsExactly(List.of(1), asList(2, 2), List.of(3), asList(4, 4, 4), List.of(5));
   ...
   public void whenGroupedRun_thenGroupedRun() {
      ...
      assertThat(grouped).containsExactly(asList(1, 1), List.of(2), List.of(3), asList(4, 4), List.of(5));

      Integer[] numbers2 = {1, 2, 3, 1};
      List<List<Integer>> grouped2 = StreamUtils.groupRuns(stream(numbers2)).collect(Collectors.toList());
      assertThat(grouped2).containsExactly(List.of(1), List.of(2), List.of(3), List.of(1));
   }
   ...
   public void whenAggregatedOnListCondition_thenAggregatedOnListCondition() {
      ...
      assertThat(aggregated).containsExactly(asList(1, 1, 2), List.of(3), List.of(4), List.of(4), List.of(5));
   }
