...
import static cn.tuyucheng.taketoday.neo4j.TestContainersTestBase.getDriver;
...
import cn.tuyucheng.taketoday.neo4j.domain.Car;
import cn.tuyucheng.taketoday.neo4j.domain.Company;
...
public class Neo4jOgmLiveTest {
   ...
   public static void oneTimeSetUp() {
      sessionFactory = new SessionFactory(getDriver(), "cn.tuyucheng.taketoday.neo4j.domain");
   ...
   void testOgm() {
      ...
      Company taketoday = new Company("taketoday");

      taketoday.setCar(tesla);

      session.save(taketoday);
      ...
      assertEquals(actual.getName(), taketoday.getName());
   }
}
