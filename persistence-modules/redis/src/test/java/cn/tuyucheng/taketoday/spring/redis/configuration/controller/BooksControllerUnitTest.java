package cn.tuyucheng.taketoday.spring.redis.configuration.controller;

import cn.tuyucheng.taketoday.spring.redis.configuration.entity.Book;
import cn.tuyucheng.taketoday.spring.redis.configuration.repository.BooksRepository;
