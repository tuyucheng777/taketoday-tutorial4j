package cn.tuyucheng.taketoday.hibernate.logging;
...
public class HibernateLoggingIntegrationTest {
   ...
   public void whenAllEmployeesAreSelected_ThenSuccess() {
      Query<Employee> query = sessionFactory.openSession().createQuery("from cn.tuyucheng.taketoday.hibernate.logging.Employee", Employee.class);
