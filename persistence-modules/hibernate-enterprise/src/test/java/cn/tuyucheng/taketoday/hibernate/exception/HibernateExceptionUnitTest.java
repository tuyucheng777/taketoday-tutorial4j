package cn.tuyucheng.taketoday.hibernate.exception;
...
public class HibernateExceptionUnitTest {
   ...
   public void whenQueryExecutedWithUnmappedEntity_thenMappingException() {
      ...
      thrown.expectMessage("Unable to locate persister: cn.tuyucheng.taketoday.hibernate.exception.ProductNotMapped");
   ...
   public void givenEntityWithoutId_whenSessionFactoryCreated_thenAnnotationException() {
      ...
      thrown.expectMessage("Entity 'cn.tuyucheng.taketoday.hibernate.exception.EntityWithNoId' has no identifier (every '@Entity' class must declare or inherit at least one '@Id' or '@EmbeddedId' property)");
   ...
   public void givenEntityWithoutId_whenCallingSave_thenThrowIdentifierGenerationException() {
      ...
      thrown.expectMessage("Identifier of entity 'cn.tuyucheng.taketoday.hibernate.exception.ProductEntity' must be manually assigned before calling 'persist()");
