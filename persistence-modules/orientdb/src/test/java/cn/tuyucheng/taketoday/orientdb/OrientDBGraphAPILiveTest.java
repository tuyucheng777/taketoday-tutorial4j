package cn.tuyucheng.taketoday.orientdb;
...
public class OrientDBGraphAPILiveTest {
   ...
   public static void setup() {
      ...
      graph = new OrientGraphNoTx("plocal:" + orientDBFolder + "/databases/TaketodayDB", "admin", "admin");
   }
   ...
   // @Test
   public void givenTaketodayDB_checkWeHaveThreeRecords() {
   ...
   // @Test
   public void givenTaketodayDB_checkWeHaveTwoWriters() {
   ...
   // @Test
   public void givenTaketodayDB_getEditorWithLevelSeven() {
      String onlyEditor = "";
