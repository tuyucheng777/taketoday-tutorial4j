package cn.tuyucheng.taketoday.jpa.savechildobjects;
...
class SaveBidirectionalChildObjectsAutomaticallyIntegrationTest {
   ...
   void givenParentWithMissedAnnotation_whenCreateEntityManagerFactory_thenPersistenceExceptionExceptionThrown() {
      ...
      assertThat(exception)
            .hasMessage("Basic collection has element type 'cn.tuyucheng.taketoday.jpa.savechildobjects.BidirectionalChild' which is not a known basic type (attribute is not annotated '@ElementCollection', '@OneToMany', or '@ManyToMany')");
   }
