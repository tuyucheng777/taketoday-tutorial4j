package cn.tuyucheng.taketoday.jpa.undeterminejdbctype;
...
public class UndetermineJDBCTypeIntegrationTest {
   ...
   void givenEntityWithoutRelationshipDeclare_whenInitialize_throwsException() {
      ...
      assertThat(exception)
            .hasMessage("Could not determine recommended JdbcType for Java type 'cn.tuyucheng.taketoday.jpa.undeterminejdbctype.Address'");
   }
