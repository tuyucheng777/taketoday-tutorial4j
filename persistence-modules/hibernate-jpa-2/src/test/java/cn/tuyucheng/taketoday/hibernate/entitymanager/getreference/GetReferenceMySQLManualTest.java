package cn.tuyucheng.taketoday.hibernate.entitymanager.getreference;
...
/**
 * We need to have a running MySQL instance and a schema named "taketoday" ready in order to execute this integration test
 */
public class GetReferenceMySQLManualTest {
   ...
   public static void setup() {
      ...
      entityManagerFactory = Persistence.createEntityManagerFactory("cn.tuyucheng.taketoday.hibernate.entitymanager.game_player_mysql");
   }
