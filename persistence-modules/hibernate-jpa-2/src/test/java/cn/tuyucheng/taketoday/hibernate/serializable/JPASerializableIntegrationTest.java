package cn.tuyucheng.taketoday.hibernate.serializable;
...
public class JPASerializableIntegrationTest {
   ...
   @Before
   public void setUp() {
      EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("cn.tuyucheng.taketoday.hibernate.serializable.h2_persistence_unit");
