...
import cn.tuyucheng.taketoday.hibernate.onetoone.sharedkeybased.Address;
import cn.tuyucheng.taketoday.hibernate.onetoone.sharedkeybased.User;
...
public class HibernateOneToOneAnnotationSPKBasedIntegrationTest {
   ...
   public void givenData_whenInsert_thenCreates1to1relationship() {
      User user = new User();
      user.setUserName("alice@taketoday.com");
   ...
   private void assert1to1InsertedData() {
      ...
      assertEquals("alice@taketoday.com", user.getUserName());
