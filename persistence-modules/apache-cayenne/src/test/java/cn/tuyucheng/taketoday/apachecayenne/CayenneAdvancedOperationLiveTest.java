package cn.tuyucheng.taketoday.apachecayenne;

import cn.tuyucheng.taketoday.apachecayenne.persistent.Author;
...
public class CayenneAdvancedOperationLiveTest {
   ...
   public void givenAuthors_whenInsertingSQLExec_thenWeGetNewAuthor() {
      int inserted = SQLExec
            .query("INSERT INTO Author (name) VALUES ('Taketoday')")
            .update(context);
   ...
   public void givenAuthors_whenUpdatingSQLExec_thenItsUpdated() {
      int updated = SQLExec
            .query("UPDATE Author SET name = 'Taketoday' WHERE name = 'Vicky Sarra'")
            .update(context);
