...
import cn.tuyucheng.taketoday.mybatisplus.codegenerator.MyBatisPlusCodeGenerator;
import cn.tuyucheng.taketoday.mybatisplus.entity.Client;
import cn.tuyucheng.taketoday.mybatisplus.idgenerator.TimestampIdGenerator;
...
public class MyBatisPlusIntegrationTest {
   ...
   public void givenMyBatisPlusCodeGenerator_whenGenerateCodeIsInvoked_thenCodeFilesAreGenerated() {
      ...
      List<String> codeFiles = Arrays.asList("src/main/java/cn/tuyucheng/taketoday/mybatisplus/entity/Client.java",
            "src/main/java/cn/tuyucheng/taketoday/mybatisplus/mapper/ClientMapper.java",
            "src/main/java/cn/tuyucheng/taketoday/mybatisplus/service/ClientService.java",
            "src/main/java/cn/tuyucheng/taketoday/mybatisplus/service/impl/ClientServiceImpl.java");
