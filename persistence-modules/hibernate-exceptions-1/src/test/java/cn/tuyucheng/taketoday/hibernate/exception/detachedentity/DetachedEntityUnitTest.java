package cn.tuyucheng.taketoday.hibernate.exception.detachedentity;

import cn.tuyucheng.taketoday.hibernate.exception.detachedentity.entity.Comment;
import cn.tuyucheng.taketoday.hibernate.exception.detachedentity.entity.Post;
...
public class DetachedEntityUnitTest {
   ...
   public void givenDetachedPost_whenTryingToPersist_thenThrowException() {
      ...
      assertThatThrownBy(() -> session.persist(detachedPost))
            ...
            .hasMessageContaining("detached entity passed to persist: cn.tuyucheng.taketoday.hibernate.exception.detachedentity.entity.Post");
   }
