package cn.tuyucheng.taketoday.querydslvsjpacriteria;

import static cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.GroupUser_.tasks;
import static cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.QGroupUser.groupUser;
import static cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.QTask.task;
import static cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.QUserGroup.userGroup;
import static cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.UserGroup_.GROUP_USERS;
...
import cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.GroupUser;
import cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.Task;
import cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.UserGroup;
import cn.tuyucheng.taketoday.querydslvsjpacriteria.entities.UserGroup_;
import cn.tuyucheng.taketoday.querydslvsjpacriteria.repositories.UserGroupJpaSpecificationRepository;
import cn.tuyucheng.taketoday.querydslvsjpacriteria.repositories.UserGroupQuerydslPredicateRepository;
...
@EnableJpaRepositories(basePackages = {"cn.tuyucheng.taketoday.querydslvsjpacriteria.repositories"})
...
class QuerydslVSJPACriteriaIntegrationTest {
   ...
   static void populateDatabase() {
      emf = Persistence.createEntityManagerFactory("cn.tuyucheng.taketoday.querydsl.intro");
