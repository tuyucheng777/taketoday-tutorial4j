package cn.tuyucheng.taketoday.cassandra.java.client.repository;
...
public class KeyspaceRepositoryLiveTest {
   ...
   public void whenCreatingAKeyspace_thenCreated() {
      String keyspaceName = "testTaketodayKeyspace";
      schemaRepository.createKeyspace(keyspaceName, "SimpleStrategy", 1);

      // ResultSet result = session.execute("SELECT * FROM system_schema.keyspaces WHERE keyspace_name = 'testTaketodayKeyspace';");
