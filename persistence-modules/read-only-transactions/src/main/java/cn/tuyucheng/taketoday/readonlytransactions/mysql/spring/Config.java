package cn.tuyucheng.taketoday.readonlytransactions.mysql.spring;
...
public class Config {
   ...
   private DataSource dataSource(boolean readOnly, boolean isAutoCommit) {
      ...
      config.setJdbcUrl("jdbc:mysql://localhost/taketoday?useUnicode=true&characterEncoding=UTF-8");
      config.setUsername("taketoday");
      config.setPassword("taketoday");
