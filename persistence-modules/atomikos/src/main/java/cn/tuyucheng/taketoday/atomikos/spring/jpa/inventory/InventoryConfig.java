package cn.tuyucheng.taketoday.atomikos.spring.jpa.inventory;
...
@Configuration
@EnableJpaRepositories(basePackages = "cn.tuyucheng.taketoday.atomikos.spring.jpa.inventory", entityManagerFactoryRef = "inventoryEntityManager", transactionManagerRef = "transactionManager")
public class InventoryConfig {
   ...
   public EntityManagerFactory inventoryEntityManager() {
      ...
      factory.setPackagesToScan("cn.tuyucheng.taketoday.atomikos.spring.jpa.inventory");
