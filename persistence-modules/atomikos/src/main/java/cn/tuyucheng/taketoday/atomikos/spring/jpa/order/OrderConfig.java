...
@Configuration
@EnableJpaRepositories(basePackages = "cn.tuyucheng.taketoday.atomikos.spring.jpa.order", entityManagerFactoryRef = "orderEntityManager", transactionManagerRef = "transactionManager")
public class OrderConfig {
   ...
   public EntityManagerFactory orderEntityManager() {
      ...
      factory.setPackagesToScan("cn.tuyucheng.taketoday.atomikos.spring.jpa.order");
