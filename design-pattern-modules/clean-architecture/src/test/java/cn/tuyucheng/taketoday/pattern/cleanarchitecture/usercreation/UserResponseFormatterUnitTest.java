...
class UserResponseFormatterUnitTest {
   ...
   void givenDateAnd3HourTime_whenPrepareSuccessView_thenReturnOnly3HourTime() {
      UserResponseModel modelResponse = new UserResponseModel("tuyucheng", "2020-12-20T03:00:00.000");
   ...
   void whenCreateUser_thenSuccess() {
      UserRequestModel userRequestModel = new UserRequestModel("tuyucheng", "123456");
      when(userFactory.create(anyString(), anyString())).thenReturn(new CommonUser("tuyucheng", "123456"));
