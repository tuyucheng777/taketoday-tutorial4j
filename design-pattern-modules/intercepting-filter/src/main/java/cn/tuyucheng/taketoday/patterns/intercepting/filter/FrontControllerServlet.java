package cn.tuyucheng.taketoday.patterns.intercepting.filter;

import cn.tuyucheng.taketoday.patterns.intercepting.filter.commands.FrontCommand;
import cn.tuyucheng.taketoday.patterns.intercepting.filter.commands.UnknownCommand;
import cn.tuyucheng.taketoday.patterns.intercepting.filter.data.Bookshelf;
import cn.tuyucheng.taketoday.patterns.intercepting.filter.data.BookshelfImpl;
   ...
   private FrontCommand getCommand(HttpServletRequest request) {
      try {
         Class type = Class.forName(
               String.format(
                     "cn.tuyucheng.taketoday.patterns.intercepting.filter.commands.%sCommand",
