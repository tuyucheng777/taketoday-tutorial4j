package cn.tuyucheng.taketoday.dddcontexts.infrastructure.events;
...
public class SimpleEventBus implements EventBus {
   ...
   public <E extends ApplicationEvent> void subscribe(String eventType, EventSubscriber subscriber) {
      Set<EventSubscriber> eventSubscribers = subscribers.computeIfAbsent(eventType, _ -> new CopyOnWriteArraySet<>());
