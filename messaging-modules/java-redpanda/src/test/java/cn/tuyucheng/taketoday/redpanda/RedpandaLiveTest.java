package cn.tuyucheng.taketoday.redpanda;
...
public class RedpandaLiveTest {
   ...
   private static final String TOPIC_NAME = "taketoday";
   ...
   void givenTopic_whenPublishMsg_thenSuccess() {
      try (final KafkaProducer<String, String> producer = createProducer()) {
         assertDoesNotThrow(() -> publishMessage("test_msg_key_2", "Hello Redpanda!", "taketoday-topic", producer));
      }
   }
