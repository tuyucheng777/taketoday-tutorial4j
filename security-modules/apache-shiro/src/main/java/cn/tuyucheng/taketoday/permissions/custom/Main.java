package cn.tuyucheng.taketoday.permissions.custom;
...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      Ini ini = Ini.fromResourcePath(Main.class.getResource("/cn/tuyucheng/taketoday/shiro/permissions/custom/shiro.ini").getPath());
      realm.setIni(ini);
