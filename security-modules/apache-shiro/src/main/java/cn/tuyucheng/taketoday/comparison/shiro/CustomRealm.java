package cn.tuyucheng.taketoday.comparison.shiro;
...
public class CustomRealm extends JdbcRealm {
...

   {
      ...
      roles.put("Jerry", new HashSet<>(List.of("ADMIN")));
      roles.put("Tom", new HashSet<>(List.of("USER")));

      permissions.put("ADMIN", new HashSet<>(Arrays.asList("READ", "WRITE")));
      permissions.put("USER", new HashSet<>(List.of("READ")));
   }
