...
import static cn.tuyucheng.taketoday.rxjava.operator.ToCleanString.toCleanString;
import static cn.tuyucheng.taketoday.rxjava.operator.ToLength.toLength;
...
public class RxJavaCustomOperatorUnitTest {
   ...
   public void whenUseFunctionOperator_thenSuccess() {
      final Operator<String, String> cleanStringFn = subscriber -> new Subscriber<>(subscriber) {
         @Override
