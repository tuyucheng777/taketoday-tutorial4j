package cn.tuyucheng.taketoday.rxjava.hooks;
...
public class RxJavaHooksUnitTest {
   ...
   public void givenObservable_whenError_shouldExecuteTheHook() {
      RxJavaPlugins.setErrorHandler(_ -> hookCalled = true);
   ...
   public void givenCompletable_whenSubscribed_shouldExecuteTheHook() {
      RxJavaPlugins.setOnCompletableSubscribe((_, observer) -> {
         hookCalled = true;
         return observer;
      });
   ...
   public void givenObservable_whenSubscribed_shouldExecuteTheHook() {
      RxJavaPlugins.setOnObservableSubscribe((_, observer) -> {
         hookCalled = true;
         return observer;
      });
