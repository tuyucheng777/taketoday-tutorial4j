package cn.tuyucheng.taketoday.reactor.flux.parallelflux;
...
public class ParallelFluxManualTest {
   ...
   public void givenFibonacciIndices_whenComputingWithParallelFlux_thenRunBenchMarks() throws IOException {
      Main.main(new String[]{
            "cn.tuyucheng.taketoday.reactor.flux.parallelflux.FibonacciFluxParallelFluxBenchmark.benchMarkParallelFluxSequential",
            "-i", "3",
            "-wi", "2",
            "-f", "1"
      });
