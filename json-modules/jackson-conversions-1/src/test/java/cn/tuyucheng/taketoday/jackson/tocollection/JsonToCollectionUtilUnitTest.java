package cn.tuyucheng.taketoday.jackson.tocollection;
...
class JsonToCollectionUtilUnitTest {
   ...
   void givenJsonString_whenCalljsonArrayToList2_thenGetException() throws IOException {
      ...
      assertThatExceptionOfType(ClassCastException.class)
            ...
            .withMessageMatching(".*java.util.LinkedHashMap cannot be cast to .*cn.tuyucheng.taketoday.jackson.tocollection.Book.*");
   }
