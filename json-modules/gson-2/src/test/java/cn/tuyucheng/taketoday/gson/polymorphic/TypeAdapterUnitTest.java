package cn.tuyucheng.taketoday.gson.polymorphic;
...
public class TypeAdapterUnitTest {
   ...
   void testSerialize() {
      ...
      assertEquals("[" +
            ...
            "\"type\":\"cn.tuyucheng.taketoday.gson.polymorphic.TypeAdapterUnitTest$Circle\"" +
            "},{" +
            "\"side\":5.0," +
            "\"area\":25.0," +
            "\"type\":\"cn.tuyucheng.taketoday.gson.polymorphic.TypeAdapterUnitTest$Square\"" +
            "}]", json);
   }
   ...
   void testDeserializeWrapper() {
      ...
      Type collectionType = new TypeToken<List<Shape>>() {
      }.getType();
