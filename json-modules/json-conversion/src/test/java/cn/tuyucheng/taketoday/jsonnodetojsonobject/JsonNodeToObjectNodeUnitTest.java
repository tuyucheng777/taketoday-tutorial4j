package cn.tuyucheng.taketoday.jsonnodetojsonobject;
...
public class JsonNodeToObjectNodeUnitTest {
   ...
   public static String jsonString = "{\"name\": \"John\", \"gender\": \"male\", \"company\": \"Taketoday\", \"isEmployee\": true, \"age\": 30}";
   ...
   public void givenJsonNode_whenConvertingToObjectNode_thenVerifyFieldsIntegrity() throws JsonProcessingException {
      ...
      assertEquals("Taketoday", objectNode.get("company").asText());
