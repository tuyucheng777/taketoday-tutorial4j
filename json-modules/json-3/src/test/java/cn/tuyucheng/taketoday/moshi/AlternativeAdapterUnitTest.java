...
public class AlternativeAdapterUnitTest {
   ...
   public void whenSerializing_thenAlternativeAdapterUsed() {
      ...
      String json = jsonAdapter.toJson(new Post("Introduction to Moshi Json", "Taketoday", Instant.now()));
   ...
   public void whenDeserializing_thenAlternativeAdapterUsed() throws IOException {
      ...
      String json = "{\"author\":\"Taketoday\",\"posted\":1582095269204,\"title\":\"Introduction to Moshi Json\"}";
