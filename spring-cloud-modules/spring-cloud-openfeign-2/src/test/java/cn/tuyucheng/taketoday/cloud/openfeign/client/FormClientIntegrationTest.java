...
import cn.tuyucheng.taketoday.cloud.openfeign.defaulterrorhandling.model.FormData;
...
class FormClientIntegrationTest {
   ...
   public void givenFormData_whenPostFormDataCalled_thenReturnSuccess() {
      FormData formData = new FormData(1, "taketoday");
