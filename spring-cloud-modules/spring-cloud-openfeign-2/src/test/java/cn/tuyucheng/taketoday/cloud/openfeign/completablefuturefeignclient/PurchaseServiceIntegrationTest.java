package cn.tuyucheng.taketoday.cloud.openfeign.completablefuturefeignclient;
...
class PurchaseServiceIntegrationTest {
   ...
   void givenRestCalls_whenBothReturnsOk_thenReturnCorrectResult() throws ExecutionException, InterruptedException {
      ...
      Assertions.assertEquals("Purchase executed with payment method credit_card", result);
   }
   ...
   void givenRestCalls_whenPurchaseReturns404_thenReturnDefault() throws ExecutionException, InterruptedException {
      ...
      Assertions.assertNotNull(result);
      Assertions.assertEquals("Purchase executed with payment method cash", result);
   }
   ...
   void givenRestCalls_whenPurchaseCompletableFutureTimeout_thenThrowNewException() {
      ...
      Assertions.assertEquals("java.lang.RuntimeException: Thread timeout!", error.getMessage());
   }
   ...
   void givenRestCalls_whenPurchaseRequestWebTimeout_thenThrowNewException() {
      ...
      Assertions.assertEquals("java.lang.RuntimeException: REST call network timeout!", error.getMessage());
   }
}