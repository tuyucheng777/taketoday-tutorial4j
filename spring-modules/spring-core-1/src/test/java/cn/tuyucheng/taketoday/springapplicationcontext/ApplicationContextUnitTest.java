package cn.tuyucheng.taketoday.springapplicationcontext;
...
public class ApplicationContextUnitTest {
   ...
   public void givenFileXmlAppContext_whenXMLConfig_thenMappingSuccess() {
      String path = "D:/workspaces/Taketoday/tutorials/spring-core-4/src/test/resources/applicationcontext/account-bean-config.xml";
