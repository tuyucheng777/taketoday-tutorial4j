...
public class ApplicationIntegrationTest {
   ...
   private void assertResponse(String response) {
      ...
      assertThat(response, containsString("john.doe@taketoday.com"));
      assertThat(response, containsString("richard.roe@taketoday.com"));
      assertThat(response, containsString("jane.doe@taketoday.com"));
