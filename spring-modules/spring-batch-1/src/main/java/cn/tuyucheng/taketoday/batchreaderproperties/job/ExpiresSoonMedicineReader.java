...
import cn.tuyucheng.taketoday.batchreaderproperties.model.MedicineCategory;
...
public class ExpiresSoonMedicineReader extends AbstractItemCountingItemStreamItemReader<Medicine> implements ContainsJobParameters {
   ...
   protected void doOpen() {
      ...
      LOGGER.info("Trace = {}. Found {} meds that expires soon", traceId, expiringMedicineList.size());
   ...
   public void beforeStep(StepExecution stepExecution) {
      JobParameters parameters = stepExecution.getJobExecution()
            .getJobParameters();
      LOGGER.info("Before step params: {}", parameters);
   }
}