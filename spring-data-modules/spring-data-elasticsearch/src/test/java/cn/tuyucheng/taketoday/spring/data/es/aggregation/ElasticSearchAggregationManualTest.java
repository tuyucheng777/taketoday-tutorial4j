package cn.tuyucheng.taketoday.spring.data.es.aggregation;

import cn.tuyucheng.taketoday.spring.data.es.aggregation.config.ElasticSearchConfig;
import cn.tuyucheng.taketoday.spring.data.es.aggregation.model.StoreItem;
import cn.tuyucheng.taketoday.spring.data.es.aggregation.repository.StoreItemRepository;
