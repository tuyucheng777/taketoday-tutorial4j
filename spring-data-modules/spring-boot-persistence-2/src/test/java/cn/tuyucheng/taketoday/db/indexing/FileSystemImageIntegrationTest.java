...
class FileSystemImageIntegrationTest {
   ...
   @Test
   void givenTaketodayImage_whenDownloadIt_thenReturnTheImage() throws Exception {
      given(fileLocationService.find(1L))
            .willReturn(taketodayJpegResource());
   ...
   private FileSystemResource taketodayJpegResource() {
      ClassLoader classLoader = ClassLoader.getSystemClassLoader();
      try {
