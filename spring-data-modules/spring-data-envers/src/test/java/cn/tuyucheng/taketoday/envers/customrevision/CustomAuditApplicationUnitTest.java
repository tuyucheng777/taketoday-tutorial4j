package cn.tuyucheng.taketoday.envers.customrevision;

import cn.tuyucheng.taketoday.envers.customrevision.domain.Owner;
import cn.tuyucheng.taketoday.envers.customrevision.domain.PetHistoryEntry;
import cn.tuyucheng.taketoday.envers.customrevision.domain.Species;
import cn.tuyucheng.taketoday.envers.customrevision.repository.OwnerRepository;
import cn.tuyucheng.taketoday.envers.customrevision.repository.SpeciesRepository;
import cn.tuyucheng.taketoday.envers.customrevision.service.AdoptionService;
import cn.tuyucheng.taketoday.envers.customrevision.service.RequestInfo;
...
public class CustomAuditApplicationUnitTest {
   ...
   void whenAdoptPet_thenSuccess() {
      ...
      assertFalse(kittyHistory.isEmpty(), "kitty should have a history");
