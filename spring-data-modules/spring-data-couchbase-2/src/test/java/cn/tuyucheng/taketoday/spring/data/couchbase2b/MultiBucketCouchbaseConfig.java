...
public class MultiBucketCouchbaseConfig extends AbstractCouchbaseConfiguration {
   ...
   public static final String DEFAULT_BUCKET_NAME = "taketoday";
   public static final String DEFAULT_BUCKET_USERNAME = "taketoday";
   public static final String DEFAULT_BUCKET_PASSWORD = "taketoday";
   ...
   public Bucket campusBucket() {
      return couchbaseCluster(ClusterEnvironment.create()).bucket("taketoday2");
   }
