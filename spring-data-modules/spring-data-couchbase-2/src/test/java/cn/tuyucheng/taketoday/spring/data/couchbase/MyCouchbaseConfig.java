...
public class MyCouchbaseConfig extends AbstractCouchbaseConfiguration {
   ...
   public static final String BUCKET_NAME = "taketoday";
   public static final String BUCKET_USERNAME = "taketoday";
   public static final String BUCKET_PASSWORD = "taketoday";
