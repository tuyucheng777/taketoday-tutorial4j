package cn.tuyucheng.taketoday.projection.config;
...
@Configuration
@ComponentScan(basePackages = "cn.tuyucheng.taketoday.projection")
@EnableMongoRepositories(basePackages = "cn.tuyucheng.taketoday.projection.repository")
