package cn.tuyucheng.taketoday.boot.atlassearch.service;

import cn.tuyucheng.taketoday.boot.atlassearch.config.IndexConfig;
...
public class MovieAtlasSearchService {
   ...
   public static void debug(List<Bson> pipeline) {
      ...
      pipeline.forEach(stage -> {
         builder.append(first.get() ? "" : ",").append(stage.toBsonDocument());
