...
@Configuration
@EnableJpaRepositories(basePackages = {"cn.tuyucheng.taketoday.boot.repository", "cn.tuyucheng.taketoday.repository"})
...
public class H2JpaConfig {
   ...
   public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
      ...
      em.setPackagesToScan(new String[]{"cn.tuyucheng.taketoday.boot.domain"});
