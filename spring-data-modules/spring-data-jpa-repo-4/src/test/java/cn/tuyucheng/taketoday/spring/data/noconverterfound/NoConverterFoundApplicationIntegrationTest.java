package cn.tuyucheng.taketoday.spring.data.noconverterfound;

import cn.tuyucheng.taketoday.spring.data.noconverterfound.models.Employee;
import cn.tuyucheng.taketoday.spring.data.noconverterfound.repositories.EmployeeRepository;
...
class NoConverterFoundApplicationIntegrationTest {
   ...
   void givenEmployee_whenGettingFullName_thenThrowException() {
      ...
      assertThatThrownBy(() -> employeeRepository.findEmployeeFullNameById(1))
            ...
            .hasMessageContaining("No converter found capable of converting from type [cn.tuyucheng.taketoday.spring.data.noconverterfound.models.Employe");
   }
