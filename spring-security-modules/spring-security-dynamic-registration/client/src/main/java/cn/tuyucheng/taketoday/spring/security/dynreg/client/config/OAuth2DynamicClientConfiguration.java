package cn.tuyucheng.taketoday.spring.security.dynreg.client.config;

import cn.tuyucheng.taketoday.spring.security.dynreg.client.service.DynamicClientRegistrationRepository;
...
public class OAuth2DynamicClientConfiguration {
   ...
   ClientRegistrationRepository dynamicClientRegistrationRepository(DynamicClientRegistrationRepository.RegistrationRestTemplate restTemplate) {
      LOGGER.info("Creating a dynamic client registration repository");
   ...
   @ConfigurationProperties(prefix = "taketoday.security.client.registration")
   @Getter
   @Setter
