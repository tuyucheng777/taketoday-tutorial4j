package cn.tuyucheng.taketoday.spring.security.authserver;
...
public class AuthorizationServerApplicationUnitTest {
   ...
   public void whenGetDiscoveryDoc_thenDynamicRegistrationEndpointEnabled() {
      ...
      LOGGER.info("Downloading openid-configuration at {}", discoveryDoc);
      ...
      LOGGER.info("Registration endpoint: {}", response.get("registration_endpoint"));
   }
