package cn.tuyucheng.taketoday.spring.security.authserver.config;

import cn.tuyucheng.taketoday.spring.security.authserver.repository.CustomRegisteredClientRepository;
...
public class SecurityConfig {
   ...
   @ConfigurationProperties(prefix = "taketoday.security.server.registration")
   @Getter
   @Setter
