...
import cn.tuyucheng.taketoday.tutorials.passkey.domain.PasskeyCredential;
...
public class DbUserCredentialRepository implements UserCredentialRepository {
   ...
   public void delete(Bytes credentialId) {
      LOGGER.info("delete: id={}", credentialId.toBase64UrlString());
   ...
   public void save(CredentialRecord credentialRecord) {
      userEntityRepository.findByExternalId(credentialRecord.getUserEntityUserId().toBase64UrlString())
            .ifPresent(user -> {
               ...
               LOGGER.info("save: user={}, externalId={}, label={}", user.getName(), user.getExternalId(), credentialRecord.getLabel());
            });
   }

   @Override
   public CredentialRecord findByCredentialId(Bytes credentialId) {
      LOGGER.info("findByCredentialId: id={}", credentialId.toBase64UrlString());
   ...
   private static CredentialRecord toCredentialRecord(PasskeyCredential credential, Bytes userId) {
      LOGGER.info("toCredentialRecord: credentialId={}, userId={}", credential.getCredentialId(), userId);
