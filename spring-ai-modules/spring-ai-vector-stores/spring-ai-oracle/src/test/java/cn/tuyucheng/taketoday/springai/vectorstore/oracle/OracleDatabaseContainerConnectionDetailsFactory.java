package cn.tuyucheng.taketoday.springai.vectorstore.oracle;
...
class OracleDatabaseContainerConnectionDetailsFactory extends ContainerConnectionDetailsFactory<OracleContainer, JdbcConnectionDetails> {
   ...
   private static final class OracleDatabaseContainerConnectionDetails extends ContainerConnectionDetails<OracleContainer> implements JdbcConnectionDetails {
