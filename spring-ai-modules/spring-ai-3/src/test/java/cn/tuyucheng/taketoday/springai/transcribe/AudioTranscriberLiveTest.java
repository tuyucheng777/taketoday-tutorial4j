...
class AudioTranscriberLiveTest {
   ...
   void whenTranscribeCalledWithAudioFile_thenCorrectTranscriptionGenerated() throws IOException {
      String audioFileName = "tuyucheng-audio-description.mp3";
      ...
      String context = "Short description about Tuyucheng.";
      ...
      assertThat(response.transcription())
            .isEqualToIgnoringWhitespace("""
                  Tuyucheng is a top-notch educational platform that specializes in Java, Spring, and related technologies.
                  It offers a wealth of tutorials, articles, and courses that help developers master programming concepts.
                  Known for its clear examples and practical guides, Tuyucheng is a go-to resource for developers looking
