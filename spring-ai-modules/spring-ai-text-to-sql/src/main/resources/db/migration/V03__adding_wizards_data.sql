...
SET
@gryffindor_house_id = (SELECT id FROM hogwarts_houses WHERE name = 'Gryffindor');

INSERT INTO wizards (name, gender, quidditch_position, blood_status, house_id)
VALUES ('Harry Potter', 'Male', 'Seeker', 'Half blood', @gryffindor_house_id),
...
SET
@hufflepuff_house_id = (SELECT id FROM hogwarts_houses WHERE name = 'Hufflepuff');

INSERT INTO wizards (name, gender, quidditch_position, blood_status, house_id)
VALUES ('Cedric Diggory', 'Male', 'Seeker', 'Pure Blood', @hufflepuff_house_id),
...
SET
@ravenclaw_house_id = (SELECT id FROM hogwarts_houses WHERE name = 'Ravenclaw');

INSERT INTO wizards (name, gender, quidditch_position, blood_status, house_id)
VALUES ('Luna Lovegood', 'Female', NULL, 'Pure Blood', @ravenclaw_house_id),
...
SET
@slytherin_house_id = (SELECT id FROM hogwarts_houses WHERE name = 'Slytherin');

INSERT INTO wizards (name, gender, quidditch_position, blood_status, house_id)
VALUES ('Draco Malfoy', 'Male', 'Seeker', 'Pure Blood', @slytherin_house_id),
