package cn.tuyucheng.taketoday.spring.zipwhen.web;

import cn.tuyucheng.taketoday.spring.zipwhen.model.User;
import cn.tuyucheng.taketoday.spring.zipwhen.service.DatabaseService;
import cn.tuyucheng.taketoday.spring.zipwhen.service.EmailService;
import cn.tuyucheng.taketoday.spring.zipwhen.service.UserService;
...
public class UserController {
   ...
   public Mono<ResponseEntity<String>> combineAllDataFor(@PathVariable String userId) {
      ...
      return userMono.zipWhen(_ -> emailSentMono, Tuples::of)
            .zipWhen(_ -> databaseResultMono, (tuple, databaseResult) -> {
