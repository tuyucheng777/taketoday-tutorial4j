package cn.tuyucheng.taketoday.spring.convertmonoobject;
...
public class MonoTransformer {
   ...
   public Mono<BookBorrowResponse> borrowBookZip(String userId, String bookId) {
      ...
      return Mono.zip(userMono, bookMono, (_, _) -> new BookBorrowResponse(userId, bookId, "Accepted"));
   }
   ...
   public Mono<Book> conditionalDiscount(String userId, String bookId) {
      return userService.getUser(userId)
            ...
            .flatMap(_ -> bookService.getBook(bookId)
                  .transform(this::applyDiscount))
   ...
   public Mono<BookBorrowResponse> handleErrorBookBorrow(String userId, String bookId) {
      return borrowBook(userId, bookId).onErrorResume(_ -> Mono.just(new BookBorrowResponse(userId, bookId, "Rejected")));
   }
}