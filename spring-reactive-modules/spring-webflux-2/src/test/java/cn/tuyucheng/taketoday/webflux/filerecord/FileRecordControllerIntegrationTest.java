...
@ComponentScan("cn.tuyucheng.taketoday.webflux.filerecord")
...
class FileRecordControllerIntegrationTest {
   ...
   public void givenUploadFilesWithEntity_whenRequestIsValid_thenReturnCreated() throws Exception {
      ...
      MockMultipartFile firstFile = new MockMultipartFile("file", "taketodaydata.txt", MediaType.TEXT_PLAIN_VALUE, "Test file content".getBytes());
      MockMultipartFile secondFile = new MockMultipartFile("file", "taketodaydata.pdf", MediaType.TEXT_PLAIN_VALUE, "Test file content".getBytes());
