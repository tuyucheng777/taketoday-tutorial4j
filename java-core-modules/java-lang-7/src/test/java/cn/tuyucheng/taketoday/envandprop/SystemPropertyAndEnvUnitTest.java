package cn.tuyucheng.taketoday.envandprop;
...
public class SystemPropertyAndEnvUnitTest {
   ...
   void whenUsingSystemSetProperty_thenGetExpectedOutput() {
      System.setProperty("nice.tech.site", "Taketoday");
      assertEquals("Taketoday", System.getProperty("nice.tech.site"));
   }
   ...
   void whenAddingEntryToSystemGetEnvMap_thenRaiseException() {
      ...
      assertThrows(UnsupportedOperationException.class, () -> sysEnv.put("TECH_SITE", "Taketoday"));
   }
