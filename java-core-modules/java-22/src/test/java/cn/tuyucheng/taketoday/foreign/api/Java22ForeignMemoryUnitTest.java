package cn.tuyucheng.taketoday.foreign.api;
...
public class Java22ForeignMemoryUnitTest {
   ...
   void whenSharedArenaCreated_thenAccessByMultipleThreads() {
      ...
      new Thread(() -> sharedArena.allocate(20));

      new Thread(() -> sharedArena.allocate(20)).start();
   }
   ...
   void whenConfinedArenaCreated_thenAccessByOwnerThread() {
      ...
      new Thread(() -> confiedArena.allocate(20));
