package cn.tuyucheng.taketoday.javafeatures.classfile;
...
public class ClassFileDriver {
   public Path updateClass() throws IOException {
      ...
      final Path PATH = Path.of("src/main/java/cn/tuyucheng/taketoday/javafeatures/classfile/ClassFileExample.class");
