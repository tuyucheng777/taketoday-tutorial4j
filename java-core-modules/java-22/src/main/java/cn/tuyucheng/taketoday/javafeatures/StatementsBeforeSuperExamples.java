...
class BaseClass {
   ...
   BaseClass(int value) {
      System.out.println(STR."BaseClass constructor: \{value}");
      this.value = value;
   }
}
...
class SimpleExample extends BaseClass {
   SimpleExample(int v) {
      ...
      super(v);
      System.out.println(STR."Initialized with value: \{v}");
   }
   ...
   SimpleExample() {
      ...
      super(v);
      System.out.println(STR."Initialized with random value: \{v}");
   }
   ...
   SimpleExample(String value) {
      ...
      super(v);
      System.out.println(STR."Initialized with parsed value: \{v}");
   }
