...
public class ExecuteJarFile {
   ...
   private static final String WORK_PATH = "src/main/java/cn/tuyucheng/taketoday/manifest";
   private static final String MANIFEST_MF_PATH = WORK_PATH + "/MANIFEST.MF";
   private static final String MAIN_MANIFEST_ATTRIBUTE = "Main-Class: cn.tuyucheng.taketoday.manifest.AppExample";

   private static final String COMPILE_COMMAND = "javac -d . AppExample.java";
   private static final String CREATE_JAR_WITHOUT_MF_ATT_COMMAND = "jar cvf example.jar cn/tuyucheng/taketoday/manifest/AppExample.class";
   private static final String CREATE_JAR_WITHOUT_MF_WITH_CP_OPTION = "jar -cp example.jar cn/tuyucheng/taketoday/manifest/AppExample";
   private static final String CREATE_JAR_WITHOUT_MF_WITH_CLASSPATH_OPTION = "jar -classpath example.jar cn/tuyucheng/taketoday/manifest/AppExample";
   private static final String CREATE_JAR_WITH_MF_ATT_COMMAND = "jar cvmf MANIFEST.MF example.jar cn/tuyucheng/taketoday/manifest/AppExample.class";
