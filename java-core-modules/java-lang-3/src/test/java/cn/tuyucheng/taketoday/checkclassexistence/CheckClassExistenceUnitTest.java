...
public class CheckClassExistenceUnitTest {
   ...
   // thrown when exception occurs inside of a static initialization block
   public void givenInitializingClass_whenUsingForName_thenInitializationError() throws ClassNotFoundException {
      Class.forName("cn.tuyucheng.taketoday.checkclassexistence.CheckClassExistenceUnitTest$InitializingClass");
   }

   @Test
   public void givenInitializingClass_whenUsingForNameWithoutInitialization_thenNoException() throws ClassNotFoundException {
      Class.forName("cn.tuyucheng.taketoday.checkclassexistence.CheckClassExistenceUnitTest$InitializingClass", false, getClass().getClassLoader());
   }
}
