...
public class ReadCSVWithCommaInValuesIntoArrayUnitTest {
   ...
   public static final List<List<String>> EXPECTED_ARRAY = Collections.unmodifiableList(new ArrayList<>() {
      {
         add(new ArrayList<>() {
            {
               add("\"Kom, Mary\"");
   ...
   public static final List<List<String>> EXPECTED_ARRAY_OpenCSV = Collections.unmodifiableList(new ArrayList<>() {
      {
         add(new ArrayList<>() {
            {
               add("Kom, Mary");
