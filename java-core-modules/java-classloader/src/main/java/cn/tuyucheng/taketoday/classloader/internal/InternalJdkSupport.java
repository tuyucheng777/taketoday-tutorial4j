...
public class InternalJdkSupport {
   ...
   static {
      ...
      try {
         ...
         log.warn("BuiltinClassLoader.ucp requires --add-opens java.base/jdk.internal.loader=taketoday.classloader");
      }
   ...
   public static Object getURLClassPath(ClassLoader loader) {
      ...
      if (UCP == null) {
         throw new UnsupportedOperationException("Program must be initialized with --add-opens java.base/jdk.internal.loader=taketoday.classloader");
      }
