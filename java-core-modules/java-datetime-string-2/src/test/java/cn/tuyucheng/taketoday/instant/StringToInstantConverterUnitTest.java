...
public class StringToInstantConverterUnitTest {
   ...
   @Test
   public void givenStringTimeStamp_whenConvertingWithInstantUsingTimeZone_thenConvertToInstant() {
   ...
   @Test
   public void givenStringTimeStamp_whenConvertingWithLocalDateTime_thenConvertToInstant() {
      DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(pattern, Locale.US);
      LocalDateTime localDateTime = LocalDateTime.parse(stringDate, dateTimeFormatter);
