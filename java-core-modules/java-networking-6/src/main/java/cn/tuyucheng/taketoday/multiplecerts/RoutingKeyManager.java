package cn.tuyucheng.taketoday.multiplecerts;
...
public class RoutingKeyManager extends X509ExtendedKeyManager {
   ...
   public String chooseEngineClientAlias(String[] keyType, Principal[] issuers, SSLEngine engine) {
      ...
      return select(host).chooseClientAlias(keyType, issuers, null);
   }

   @Override
   public String chooseEngineServerAlias(String keyType, Principal[] issuers, SSLEngine engine) {
      String host = engine.getPeerHost();
      return select(host).chooseServerAlias(keyType, issuers, null);
   }
   ...
   public String[] getClientAliases(String keyType, Principal[] issuers) {
      ...
      hostMap.forEach((_, km) -> aliases.addAll(Arrays.asList(km.getClientAliases(keyType, issuers))));
   ...
   public String[] getServerAliases(String keyType, Principal[] issuers) {
      ...
      hostMap.forEach((_, km) -> list.addAll(Arrays.asList(km.getServerAliases(keyType, issuers))));
