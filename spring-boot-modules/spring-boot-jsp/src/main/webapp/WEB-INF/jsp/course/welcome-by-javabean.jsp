...
<jsp:useBean id="courseWelcomeBean" class="cn.tuyucheng.taketoday.boot.jsp.coursewelcome.CourseWelcomeBean"/>
...
<div><%= courseWelcomeBean.greetingUser()%>
</div>
<div><%= courseWelcomeBean.welcomeMsg()%>
</div>
</body>
</html>