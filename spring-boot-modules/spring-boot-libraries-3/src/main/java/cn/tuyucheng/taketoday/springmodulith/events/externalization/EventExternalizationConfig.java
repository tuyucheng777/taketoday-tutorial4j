...
class EventExternalizationConfig {
   ...
   EventExternalizationConfiguration eventExternalizationConfiguration() {
      return EventExternalizationConfiguration.externalizing()
            ...
            .route(
                  ...
                  it -> RoutingTarget.forTarget("taketoday.articles.published").andKey(it.slug())
            )
            .mapping(
                  ArticlePublishedEvent.class,
            ...
            .route(
                  ...
                  it -> RoutingTarget.forTarget("taketoday.articles.published").andKey(it.handle())
            )
            .mapping(
                  WeeklySummaryPublishedEvent.class,
   ...
   KafkaOperations<String, ArticlePublishedEvent> kafkaOperations(KafkaProperties kafkaProperties) {
      ProducerFactory<String, ArticlePublishedEvent> producerFactory = new DefaultKafkaProducerFactory<>(kafkaProperties.buildProducerProperties(null));
