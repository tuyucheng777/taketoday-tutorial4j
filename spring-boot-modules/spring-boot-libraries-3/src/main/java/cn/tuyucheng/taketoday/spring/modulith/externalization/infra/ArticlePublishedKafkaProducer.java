package cn.tuyucheng.taketoday.spring.modulith.externalization.infra;

import cn.tuyucheng.taketoday.spring.modulith.externalization.ArticlePublishedEvent;
...
class ArticlePublishedKafkaProducer {
   ...
   public void publishAsync(ArticlePublishedEvent article) {
      ...
      messageProducer.send("tuyucheng.articles.published", article.slug(), article);
   }
}