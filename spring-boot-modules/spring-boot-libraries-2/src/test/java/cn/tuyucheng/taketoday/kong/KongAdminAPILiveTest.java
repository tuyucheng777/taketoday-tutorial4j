...
public class KongAdminAPILiveTest {
   ...
   public void givenAdminAPIProxy_whenAddAPIViaProxy_thenAPIAdded() throws Exception {
      ...
      APIObject taketodayAPI = new APIObject("taketoday-api", "taketoday.com", "http://ww.taketoday.com", "/");
      RequestEntity<APIObject> requestEntity = new RequestEntity<>(taketodayAPI, headers, HttpMethod.POST, new URI("http://localhost:8000/admin-api"));
