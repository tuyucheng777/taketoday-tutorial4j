package cn.tuyucheng.taketoday.airag;

import cn.tuyucheng.taketoday.airag.service.ChatBotService;
import cn.tuyucheng.taketoday.airag.service.DataLoaderService;
import cn.tuyucheng.taketoday.airag.service.DataRetrievalService;
...
class SpringAiRagApplicationLiveTest {
   ...
   private final Logger logger = LoggerFactory.getLogger(SpringAiRagApplicationLiveTest.class);
   @Autowired
