...
import cn.tuyucheng.taketoday.boot.documentation.springwolf.SpringwolfApplication;
...
@TestPropertySource(properties = "springwolf.plugin.kafka.publishing.enabled=false")
// baeldung spring kafka does not match springwolf kafka
@DirtiesContext
