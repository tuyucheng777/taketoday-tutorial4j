...
public class IntegrationMultidocumentFilesIntegrationTest {
   ...
   @Value("${take.otherProperty}")
   private String takeCustomOtherProperty;
   ...
   public void givenProductionProfileActive_whenApplicationStarts_thenDefaultPropertiesUser() {
      assertThat(takeCustomProperty).isEqualTo("integrationValue");
      assertThat(takeCustomOtherProperty).isEqualTo("integrationExtensionOtherValue");
