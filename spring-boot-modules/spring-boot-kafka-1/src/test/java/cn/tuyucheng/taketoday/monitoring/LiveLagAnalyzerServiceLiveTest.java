...
import cn.tuyucheng.taketoday.monitoring.service.LagAnalyzerService;
...
public class LiveLagAnalyzerServiceLiveTest {
   ...
   private static final String GROUP_ID = "taketodayGrp";
   private static final String TOPIC = "taketoday";
   ...
   @Test
   public void givenEmbeddedKafkaBroker_whenMessageNotConsumed_thenLagIsEqualToProducedMessage() throws ExecutionException, InterruptedException {
      produce();
