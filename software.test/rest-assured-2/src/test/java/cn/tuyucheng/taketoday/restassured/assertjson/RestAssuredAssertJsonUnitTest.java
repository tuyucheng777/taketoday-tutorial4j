package cn.tuyucheng.taketoday.restassured.assertjson;

import cn.tuyucheng.taketoday.restassured.assertjson.WebsitePojo.WebsiteText;
...
class RestAssuredAssertJsonUnitTest extends WireMockTestBase {
   ...
   void whenGetBody_thenCanCompareByWholeString() {
      ...
      assertThat(body)
            .isEqualTo("{\"name\":\"tuyucheng\",\"type\":\"website\",\"text\":{\"language\":\"english\",\"code\":\"java\"}}");
   }
   ...
   void whenGetBody_thenCompareByWholeStringIsSensitiveToFieldOrder() {
      ...
      assertThat(body)
            .isNotEqualTo("{\"type\":\"website\",\"name\":\"tuyucheng\",\"text\":{\"language\":\"english\",\"code\":\"java\"}}");
   }
   ...
   void whenGetBody_thenCanCompareByPojo() {
      ...
      assertThat(body)
            .isEqualTo(new WebsitePojo("tuyucheng", "website", new WebsiteText("english", "java")));
   }
