...
class RestAssuredAssertJsonWithJsonAssertUnitTest extends WireMockTestBase {
   ...
   void whenGetBody_thenCanCompareByJsonAssert() throws Exception {
      ...
      JSONAssert.assertEquals("{\"name\":\"tuyucheng\",\"type\":\"website\",\"text\":{\"language\":\"english\",\"code\":\"java\"}}", body, JSONCompareMode.STRICT);
   }
   ...
   void whenGetBody_thenCanCompareByJsonAssertWithFieldsInDifferentOrder() throws Exception {
      ...
      JSONAssert.assertEquals("{\"type\":\"website\",\"name\":\"tuyucheng\",\"text\":{\"language\":\"english\",\"code\":\"java\"}}", body, JSONCompareMode.STRICT);
   }
