...
class RestAssuredAssertJsonWithJsonUnitUnitTest extends WireMockTestBase {
   ...
   void whenGetBody_thenCanCompareByJsonUnitWithFieldsInDifferentOrder() {
      ...
      assertThatJson(body)
            .isEqualTo("{\"type\":\"website\",\"name\":\"tuyucheng\",\"text\":{\"language\":\"english\",\"code\":\"java\"}}");
   }
   ...
   void whenGetBody_thenCanCompareByJsonUnitAgainstUnpredictableFields() {
      ...
      assertThatJson(body)
            .isEqualTo("{\"build\":\"${json-unit.regex}[0-9a-f-]+\",\"timestamp\":\"${json-unit.any-string}\",\"type\":\"website\",\"name\":\"tuyucheng\",\"text\":{\"language\":\"english\",\"code\":\"java\"}}");
   }
}