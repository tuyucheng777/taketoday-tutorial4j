package cn.tuyucheng.taketoday.poi.excel.insert.multilinetext;

import cn.tuyucheng.taketoday.poi.excel.multilinetext.MultilineText;
...
public class MultilineTextUnitTest {
   ...
   public void givenMultilineTextCell_whenFormated_thenMultilineTextVisible() throws IOException {
      ...
      assertEquals(row.getHeightInPoints(), testWorkbook.getSheetAt(0)
            .getRow(STRING_ROW_INDEX)
            .getHeightInPoints(), 0.0);
