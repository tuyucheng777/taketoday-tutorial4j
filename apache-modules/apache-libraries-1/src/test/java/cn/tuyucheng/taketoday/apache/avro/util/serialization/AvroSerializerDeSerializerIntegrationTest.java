...
import cn.tuyucheng.taketoday.apache.avro.generated.Active;
import cn.tuyucheng.taketoday.apache.avro.generated.AvroHttpRequest;

import cn.tuyucheng.taketoday.apache.avro.generated.ClientIdentifier;
...
public class AvroSerializerDeSerializerIntegrationTest {
   ...
   public void WhenDeserializeUsingJSONDecoder_thenActualAndExpectedObjectsAreEqual() {
      ...
      assertEquals(Long.valueOf(actualRequest.getRequestTime()), request.getRequestTime());
   }
