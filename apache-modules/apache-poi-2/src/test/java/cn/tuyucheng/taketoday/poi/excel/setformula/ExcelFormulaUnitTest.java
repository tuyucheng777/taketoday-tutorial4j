package cn.tuyucheng.taketoday.poi.excel.setformula;
...
class ExcelFormulaUnitTest {
   private static final String FILE_NAME = "cn/tuyucheng/taketoday/poi/excel/setformula/SetFormulaTest.xlsx";
