package cn.tuyucheng.taketoday.bytearraybytestring;
...
public class ByteArrayByteStringUnitTest {
   ...
   @Test
   void givenByteArray_whenModified_thenChangesPersist() {
   ...
   @Test
   void givenByteString_whenCreated_thenIsImmutable() {
   ...
   @Test
   void givenByteArray_whenCopiedToByteString_thenDataIsCopied() {
   ...
   @Test
   void givenByteString_whenConvertedToByteArray_thenDataIsCopied() {
      // We'll start with an immutable ByteString
      ByteString byteString = ByteString.copyFromUtf8("Tuyucheng");
